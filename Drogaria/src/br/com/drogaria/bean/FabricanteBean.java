...
public class FabricanteBean {
	...
	public void novo() {
		try {
			...
			JSFUtil.adicionarMessagemSucesso("Fabricante salvo com sucesso.");
		} catch (SQLException e) {
			e.printStackTrace();
			JSFUtil.adicionarMessagemErro(e.getMessage());
		}
	...
	public void excluir() {
		...
		try {
			...
			JSFUtil.adicionarMessagemSucesso("Fabricante excluido com sucesso.");
		} catch (SQLException e) {
			e.printStackTrace();
			JSFUtil.adicionarMessagemErro(e.getMessage());
		}
	...
	public void editar() {
		try {
			...
			JSFUtil.adicionarMessagemSucesso("Fabricante alterado com sucesso.");
		} catch (SQLException e) {
			e.printStackTrace();
			JSFUtil.adicionarMessagemErro(e.getMessage());
		}
